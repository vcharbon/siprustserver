...
/// The JSON **Endpoint config** (ADR-0018) — moved to the dependency-light
/// `e2e-model` crate; re-exported so `crate::infra::EndpointConfig` (and the
/// `e2e_core::EndpointConfig` root export) are unchanged.
pub use e2e_model::EndpointConfig;
